...
const PLANS = [
    {
        ...
        name: "Starter",
        price: "Free",
        features: ["1 workspace", "5 members", "50 tasks"],
        color: "#64748b",
    },
    {
        id: "PROFESSIONAL",
        name: "Professional",
        price: "$29/mo",
        features: ["5 workspaces", "25 members", "Unlimited tasks"],
        color: "#3b82f6",
    },
    {
        id: "ENTERPRISE",
        name: "Enterprise",
        price: "$99/mo",
        features: ["Unlimited workspaces", "Unlimited members", "Priority support"],
        color: "#7c3aed",
    },
];
