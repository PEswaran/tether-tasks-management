...
import { getMyMemberships, getMyTenantId } from "../libs/isOwner";
    ...
    async function load() {
        ...
        try {
            ...
            if (workspaceId) {
                ...
                await loadGlobal(ownerWsIds, tenantId);
            }
        } catch (err) {
            ...
            <div className="kpi-grid">
                ...
                <div className="kpi-card" onClick={() => navigate("/owner/boards")}>
                    ...
                    <div className="kpi-body">
                        ...
                        <span className="kpi-value">
                            <CountUp end={stats.boards} duration={0.8} />
                        </span>
                    </div>
                    <ArrowUpRight size={16} className="kpi-arrow" />
                </div>

                <div className="kpi-card" onClick={() => navigate("/owner/members")}>
